...
int compress(struct HEntry** const table, const void* src, size_t length, void* dst, bitpos_t* pos)
{
...
size_t decompress(const struct HTree* root, const void* src, bitpos_t* pos, const bitpos_t* end, void* dst)
{
